...
#
#PS C:\home\auld\godev\src\github.com\WarrenDSmiths\IEVS> .\build.ps1
#PS C:\home\auld\godev\src\github.com\WarrenDSmiths\IEVS> .\a.exe
...
#NumMethods=68   NumCoreMethods=12       TRUE=1  FALSE=0
#ArtinPrime=196549
#BROutputMode=0
#
...
#the regret tables:
#0. Simulation output file name? enter name or 'none'<return> is not desired.
#none
#Simulation output will be written to the terminal.
#
